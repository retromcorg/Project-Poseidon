...
class PlayerInstance {
    ...
    // Poseidon
    private static final boolean asyncChunkLoading = PoseidonConfig.getInstance().getConfigBoolean("world.settings.async-chunk-loading.enabled", false);
    ...
    private CompletableFuture<Chunk> chunk; // Poseidon
    ...
    public void a(EntityPlayer entityplayer) {
        // Poseidon
        this.chunk = this.chunk.thenApply(chunk -> {
